...
!define COMPANY "catTHIS Core project"
...
!else
InstallDir $PROGRAMFILES\catthis
!endif
CRCCheck on
XPStyle on
BrandingText " "
...
VIAddVersionKey ProductName "catTHIS Core"
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\catthis-qt
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\catTHIS Core (testnet, -bit).lnk" "$INSTDIR\catthis-qt" "-testnet" "$INSTDIR\catthis-qt" 1
    ...
    WriteRegStr HKCR "catthis" "URL Protocol" ""
    WriteRegStr HKCR "catthis" "" "URL:catthis"
    WriteRegStr HKCR "catthis\DefaultIcon" "" $INSTDIR\catthis-qt
    WriteRegStr HKCR "catthis\shell\open\command" "" '"$INSTDIR\catthis-qt" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\catthis-qt
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\catTHIS Core (testnet, -bit).lnk"
    Delete /REBOOTOK "$SMSTARTUP\catthis.lnk"
