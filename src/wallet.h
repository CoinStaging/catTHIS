...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 catthis at the same time
...
enum ZerocoinSpendStatus {
    Zcatthis_SPEND_OKAY = 0,                            // No error
    Zcatthis_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    Zcatthis_WALLET_LOCKED = 2,                         // Wallet was locked
    Zcatthis_COMMIT_FAILED = 3,                         // Commit failed, reset status
    Zcatthis_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    Zcatthis_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    Zcatthis_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    Zcatthis_TRX_CREATE = 7,                            // Everything related to create the transaction
    Zcatthis_TRX_CHANGE = 8,                            // Everything related to transaction change
    Zcatthis_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    Zcatthis_INVALID_COIN = 10,                         // Selected mint coin is not valid
    Zcatthis_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    Zcatthis_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    Zcatthis_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    Zcatthis_SPENT_USED_Zcatthis = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZcatthisAutoBackups(bool fEnabled)
    {
