...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("catTHIS Core catthis-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  catthis-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded catthis transaction") + "\n" +
                               "  catthis-tx [options] -create [commands]   " + _("Create hex-encoded catthis transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded catthis transaction
