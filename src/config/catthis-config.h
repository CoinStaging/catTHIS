/* src/config/catthis-config.h.  Generated from catthis-config.h.in by configure.  */
/* src/config/catthis-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef catthis_CONFIG_H

#define catthis_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.catthis.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "catTHIS Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "catTHIS Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "catthis"
