...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "catthis server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* catthis features */
        {"catthis", "masternode", &masternode, true, true, false},
        {"catthis", "listmasternodes", &listmasternodes, true, true, false},
        {"catthis", "getmasternodecount", &getmasternodecount, true, true, false},
        {"catthis", "masternodeconnect", &masternodeconnect, true, true, false},
        {"catthis", "masternodecurrent", &masternodecurrent, true, true, false},
        {"catthis", "masternodedebug", &masternodedebug, true, true, false},
        {"catthis", "startmasternode", &startmasternode, true, true, false},
        {"catthis", "createmasternodekey", &createmasternodekey, true, true, false},
        {"catthis", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"catthis", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"catthis", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"catthis", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"catthis", "getmasternodescores", &getmasternodescores, true, true, false},
        {"catthis", "mnbudget", &mnbudget, true, true, false},
        {"catthis", "preparebudget", &preparebudget, true, true, false},
        {"catthis", "submitbudget", &submitbudget, true, true, false},
        {"catthis", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"catthis", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"catthis", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"catthis", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"catthis", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"catthis", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"catthis", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"catthis", "checkbudgets", &checkbudgets, true, true, false},
        {"catthis", "mnsync", &mnsync, true, true, false},
        {"catthis", "spork", &spork, true, true, false},
        {"catthis", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"catthis", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use catthisd, or the -server option to catthis-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> catthis-cli " + methodname + " " + args + "\n";
}
