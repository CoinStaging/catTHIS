                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("catTHIS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a catthis address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and catTHIS: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zcats"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About catTHIS Core"), this);
    aboutAction->setStatusTip(tr("Show information about catTHIS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for catthis"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your catthis addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified catthis addresses"));
    ...
    openAction->setStatusTip(tr("Open a catTHIS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the catTHIS Core help message to get a list with possible catthis command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("catTHIS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to catthis network", "", count));
}
...
{
    QString strTitle = tr("catTHIS Core"); // default title
...
/** Creates context menu, its actions, and catthiss up all the relevant signals for mouse events. */
