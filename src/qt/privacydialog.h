...
public:
    ...
    void setZcatthisControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzcats_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzcats_clicked();
    void on_pushButtonZcatthisControl_clicked();
