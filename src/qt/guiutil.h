...
/** Utility functions used by the catthis Qt UI.
 */
namespace GUIUtil
{
...
// Render catthis addresses in monospace font
...
// Parse "catTHIS:" URI into recipient object, return true on successful parsing
