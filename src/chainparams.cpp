...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 22711;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 catthis starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 30; // catTHIS: 0.5 minutes
        nTargetSpacingSlowLaunch = 10 * 60;  // catTHIS: 10 minutes (Slow launch - Block 288)
        nTargetSpacing = 1 * 60;  // catTHIS: 60 Seconds
        nMaturity = 19;
        ...
        nZerocoinStartTime = 1557459262; // 14 - apr - 2018
         ...
         */
        const char* pszTimestamp = "catthis new blockchain is here";
        ...
        assert(genesis.hashMerkleRoot == uint256("0xf25e21c3332473f077bba1869425b90b1ed85c25bd12e8d7beaf30aadfc04b3e"));

    	vSeeds.push_back(CDNSSeedData("45.32.135.249", "45.32.135.249"));
		vSeeds.push_back(CDNSSeedData("204.48.16.94", "204.48.16.94"));
		vSeeds.push_back(CDNSSeedData("138.197.216.210", "138.197.216.210"));
		vSeeds.push_back(CDNSSeedData("178.62.209.76", "178.62.209.76"));
		vSeeds.push_back(CDNSSeedData("157.230.34.145", "157.230.34.145"));
		vSeeds.push_back(CDNSSeedData("159.65.94.213", "159.65.94.213"));
        ...
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x01)(0x1d)(0xfc).convert_to_container<std::vector<unsigned char> >();
...
{
	return "CLHeTTJgYtJraZBAHXps2i5uaAaKXbj5zR";
}
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // catTHIS: 1 day
        nTargetSpacing = 1 * 60;  // catTHIS: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet catthis addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet catthis script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet catthis BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet catthis BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet catthis BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // catTHIS: 1 day
        nTargetSpacing = 1 * 60;        // catTHIS: 1 minutes
