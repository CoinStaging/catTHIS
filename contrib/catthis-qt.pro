...
RESOURCES += src/qt/catthis.qrc src/qt/catthis_locale.qrc

TRANSLATIONS += src/qt/locale/catthis_bg.ts \
                src/qt/locale/catthis_de.ts \
                src/qt/locale/catthis_en.ts \
                src/qt/locale/catthis_es.ts \
                src/qt/locale/catthis_fi.ts \
                src/qt/locale/catthis_fr.ts \
                src/qt/locale/catthis_it.ts \
                src/qt/locale/catthis_ja.ts \
                src/qt/locale/catthis_pl.ts \
                src/qt/locale/catthis_pt.ts \
                src/qt/locale/catthis_ru.ts \
                src/qt/locale/catthis_sk.ts \
                src/qt/locale/catthis_sv.ts \
                src/qt/locale/catthis_vi.ts \
                src/qt/locale/catthis_zh_CN.ts \
                src/qt/locale/catthis_zh_TW.ts
