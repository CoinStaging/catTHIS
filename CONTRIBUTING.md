Contributing to catTHIS Core
============================

The catTHIS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the catTHIS Core project, and is not to be
confused with overall catthis Network Protocol consensus changes.

Whether a pull request is merged into catTHIS Core rests with the project merge
...
Patches that change catthis consensus rules are considerably more involved than
...
Where a patch set proposes to change the catthis consensus, it must have been
...
The project leader is the release manager for each catTHIS Core release.
